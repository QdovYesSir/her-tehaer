    ...
    if (method) {
        switch (method) {
            case 'qris':
                ...
                paymentQr.src = 'qris1.png'; // Ganti dengan QRIS asli
                paymentNumber.textContent = '';
                break;
            case 'dana':
                paymentDesc.textContent = 'Langsung transfer saja broo🤑!!!';
                paymentQr.src = 'dana1.jpg'; // Ganti dengan QR Dana asli
                paymentNumber.textContent = '0857-1953-0659'; // Ganti dengan nomor Dana kamu
                break;
            case 'gopay':
                paymentDesc.textContent = 'Langsung transfer saja broo🤑!!!';
                paymentQr.src = 'gopay1.jpg'; // Ganti dengan QR GoPay asli
                paymentNumber.textContent = '0857-1953-0659'; // Ganti dengan nomor GoPay kamu
                break;
        }
    } else {
